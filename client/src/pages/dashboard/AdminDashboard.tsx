...
export default function AdminDashboard() {
  ...
  const navItems: NavItem[] = [
    { label: "Dashboard", icon: LayoutDashboard, iconColor: "text-sky-500 dark:text-sky-400", active: activeView === "dashboard", onClick: () => setActiveView("dashboard") },
    { label: "User Management", icon: Users, iconColor: "text-blue-500 dark:text-blue-400", active: activeView === "users", onClick: () => setActiveView("users") },
    { label: "SACCO Management", icon: Building2, iconColor: "text-emerald-500 dark:text-emerald-400", active: activeView === "saccos", onClick: () => setActiveView("saccos") },
    { label: "Fraud Alerts", icon: AlertTriangle, iconColor: "text-red-500 dark:text-red-400", active: activeView === "fraud", onClick: () => setActiveView("fraud") },
    { label: "Blacklist", icon: ShieldOff, iconColor: "text-rose-500 dark:text-rose-400", active: activeView === "blacklist", onClick: () => setActiveView("blacklist") },
    { label: "Audit Logs", icon: FileText, iconColor: "text-amber-500 dark:text-amber-400", active: activeView === "audit", onClick: () => setActiveView("audit") },
    { label: "Analytics", icon: BarChart3, iconColor: "text-violet-500 dark:text-violet-400", active: activeView === "analytics", onClick: () => setActiveView("analytics") },
    { label: "Risk Policies", icon: ShieldCheck, iconColor: "text-teal-500 dark:text-teal-400", active: activeView === "risk", onClick: () => setActiveView("risk") },
    { label: "System Config", icon: Settings, iconColor: "text-slate-500 dark:text-slate-400", active: activeView === "config", onClick: () => setActiveView("config") },
    { label: "Role Management", icon: UserCog, iconColor: "text-indigo-500 dark:text-indigo-400", active: activeView === "roles", onClick: () => setActiveView("roles") },
    { label: "Data Exports", icon: Database, iconColor: "text-cyan-500 dark:text-cyan-400", active: activeView === "exports", onClick: () => setActiveView("exports") },
    { label: "Automation", icon: Bot, iconColor: "text-fuchsia-500 dark:text-fuchsia-400", active: activeView === "automation", onClick: () => setActiveView("automation") },
    {
      label: "Rule Engine",
      icon: Shield,
