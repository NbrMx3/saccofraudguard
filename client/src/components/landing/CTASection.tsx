  ...
  return (
    <section className="relative bg-[#020a18] py-24 sm:py-32 overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-125 h-100 bg-cyan-500/6 rounded-full blur-[100px]" />
      </div>

      <div className="relative mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        <div className="rounded-3xl border border-white/8 bg-linear-to-br from-slate-900/80 to-slate-800/40 p-10 sm:p-16 text-center backdrop-blur-sm shadow-2xl">
          {/* Icon */}
          ...
          <div className="mt-10 flex flex-col gap-4 sm:flex-row sm:justify-center">
            <Link
              to="/login"
              className="group inline-flex items-center justify-center gap-2.5 rounded-2xl bg-linear-to-r from-cyan-500 to-teal-600 px-8 py-4 text-base font-semibold text-white shadow-xl shadow-cyan-500/20 transition-all hover:shadow-cyan-500/30 hover:from-cyan-400 hover:to-teal-500 active:scale-[0.98]"
            >
              Access System
